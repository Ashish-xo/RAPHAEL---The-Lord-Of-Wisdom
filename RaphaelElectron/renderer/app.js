...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ──────────── Web Audio Mic Frequency Analyzer ────────────
    ...
    // ──────────── Raphael Voice Engine (Tensura Anime Character Profile) ────────────
    let systemVoices = [];
    ...
    // ──────────── DeepSeek API Integration (DeepSeek-V4-Flash-0731) ────────────
